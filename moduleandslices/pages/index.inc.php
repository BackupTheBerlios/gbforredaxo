...
if (!class_exists ('Template')) {
  include_once ($REX['INCLUDE_PATH'].'/addons/moduleandslices/classes/template.inc.php');
}
...
$AuswahlLinks = '<a href="index.php?page=moduleandslices&amp;subpage=leer">[ModuleAndSlices]</a>';

$AuswahlLinks .= '&#160;<a href="index.php?page=moduleandslices&amp;subpage=templates">[ArticleAndTemplates]</a>';
$AuswahlLinks .= '<br />Statistik::';
$AuswahlLinks .= '<a href="index.php?page=moduleandslices&amp;subpage=statistik_module">[Module]</a>';
$AuswahlLinks .= '&#160;<a href="index.php?page=moduleandslices&amp;subpage=statistik_templates">[Templates]</a>';
$AuswahlLinks .= '&#160;<a href="index.php?page=moduleandslices&amp;subpage=statistik_actions">[Actions]</a>';
